      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="flex gap-4 mb-6 border-b border-white/10">
          <button
            ...
            className={`px-6 py-3 font-semibold transition-colors ${activeTab === 'properties'
          ...
          <button
            ...
            className={`px-6 py-3 font-semibold transition-colors ${activeTab === 'designs'
              ? 'text-fbm-gold-400 border-b-2 border-fbm-gold-400'
              : 'text-white/60 hover:text-white'
              }`}
          >
                  ...
                  <tr key={property.id} className="hover:bg-white/5 transition-colors">
                    <td className="p-4">
                      <div className="relative w-32 h-24 rounded overflow-hidden border border-white/10 bg-fbm-navy-900/50">
                        <Image
                          src={property.image_urls?.[0] || '/logo-transparent.png'}
                          alt={property.title}
                          fill
                    ...
                    <td className="p-4 text-center">
                      <button
                        ...
                        className={`px-3 py-1 rounded-full text-xs font-bold border ${property.status === 'aktif'
                ...
                {designs.map((design) => (
                  <tr key={design.id} className="hover:bg-white/5 transition-colors">
                    <td className="p-4">
                      <div className="relative w-32 h-24 rounded overflow-hidden border border-white/10 bg-fbm-navy-900/50">
                        <Image
                          src={design.image_urls?.[0] || '/logo-transparent.png'}
                          alt={design.title}
                          fill
