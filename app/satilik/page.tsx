...
export default function SatilikPage() {
  const [properties, setProperties] = useState(() => generateRandomProperties(12, false));

  useEffect(() => {
    // Client-side'da render olduktan sonra güncelle (hydration sonrası)
    const timer = setTimeout(() => {
      setProperties(generateRandomProperties(12, false));
    }, 0);
      ...
      <div className="container mx-auto">
        <div className="mb-12 text-center">
          ...
          <p className="font-sans text-lg text-white/80 max-w-2xl mx-auto">
            Hayalinizdeki evi bulun. Seçkin lokasyonlarda, kaliteli yapılar ve en iyi fiyat garantisi.
          </p>
        </div>
