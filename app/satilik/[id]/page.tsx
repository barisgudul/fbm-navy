...
export default function SatilikDetailPage() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      const allProperties = generateRandomProperties(100, false);
    ...
    <main className="min-h-screen pt-36 md:pt-40 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-fbm-denim-750/50 backdrop-blur-sm rounded-lg p-8 border border-fbm-sage-200/30">
            <h2 className="font-serif text-3xl text-fbm-gold-400 mb-6">Fiyat Bilgileri</h2>
            <div className="space-y-4">
              <div className="mb-6">
                <p className="text-white/60 mb-2">Satış Fiyatı</p>
                <p className="font-serif text-4xl text-fbm-gold-400 font-bold">{property.price}</p>
              </div>
              <div className="space-y-3 text-sm text-white/80">
                <p>• Peşin ödeme avantajları mevcuttur</p>
                <p>• Kredi başvurusu için destek sağlanmaktadır</p>
                <p>• Taksitli ödeme seçenekleri bulunmaktadır</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-fbm-denim-750/50 backdrop-blur-sm rounded-lg p-8 border border-fbm-sage-200/30 mt-8">
          ...
          <p className="text-white/80 leading-relaxed">
            ...
            Toplam {property.area} m² brüt alanı bulunan konut, modern tasarım dinamikleriyle tasarlanmıştır. 
