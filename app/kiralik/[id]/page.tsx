...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const metaDescription = data.description 
    ...
    : `${data.title} - ${data.rooms} oda, ${data.living_rooms} salon, ${data.area}m². ${data.location}, Isparta. Aylık ${data.price}. FBM Gayrimenkul güvencesiyle.`;

  return {
    title: `${data.title} - Kiralık ${data.rooms}+${data.living_rooms} | FBM Gayrimenkul Isparta`,
